...
\begin{figure}[ht]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot[color=blue]{2}; \addlegendentry{$O_1$}
			\addplot[color=yellow]{4}; \addlegendentry{$O_2$}
			\addplot[color=red]{6}; \addlegendentry{$O_3$}
		\end{axis}
	\end{tikzpicture}
	\caption{Remuneração}
\end{figure}
...
\begin{figure}[ht!]
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\addplot[color=blue, smooth]{-x^2 + x + 4}; \addlegendentry{$Pmg_L$}
		\end{axis}
	\end{tikzpicture}
